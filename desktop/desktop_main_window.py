...
class MainWindow(QMainWindow):
    def __init__(self):
        ...
        # self.web_view.load(QUrl("http://localhost:5173/"))  # 使用 QUrl 加载网页地址
        self.web_view.load(QUrl("http://localhost:8777/"))
        ...
        x = int(screen.width() * 0.50 - w/2)  # 屏幕宽度的5%
        y = int(screen.height() * 0.50 - h/2)  # 屏幕高度的5%
        
        self.setGeometry(x, y, w, h)  # 设置初始位置和大小
